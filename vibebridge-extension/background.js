...
let mcpAlive = false;
let serversCache = [];
// true/false = a PLACE is loaded and usable in VSCode; null = unknown.
...
// true/false = a VSCode app is connected to the MCP server at all; null =
...
let studioApp = null;
// true/false = a VSCode WINDOW/PROCESS exists on this machine (checked
...
// launched ("open VSCode") vs Studio OPEN but its MCP plugin never
...
// "open VSCode" wording completely fails to convey.
let studioProc = null;
...
// Ask the bridge whether a VSCode instance is actually connected to the
