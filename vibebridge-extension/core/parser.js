...
// core/parser.js - VibeBridge command parsing. PURE string logic, zero DOM:
...
const ZSParse = (() => {
  ...
  // The optional `:Edit|:Server|:Client` suffix selects the VSCode datamodel
  ...
  // instead of a VibeBridge command - seen live in user reports, DeepSeek only:
  //   <|DSML|>tool_calls>
  ...
  // new VibeBridge schema ("command"/"params") and the legacy/function-calling
  ...
  // The assistant emitted a VibeBridge command (JSON or a ###LUA### block), or a
