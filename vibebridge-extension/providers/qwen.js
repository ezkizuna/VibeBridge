...
const ZSProvider = (() => {
  ...
  // Scope to the site's composer only; skip VibeBridge's own injected textarea
  ...
  function truncateForSend(text) {
    ...
    const marker =
      `\n\n[…VibeBridge: result truncated to fit Qwen's ${SEND_CAP}-character input ` +
  ...
  // tool-calls instead of VibeBridge commands. Removed 2026-07: the real cause of
