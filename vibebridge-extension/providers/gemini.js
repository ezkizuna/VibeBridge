...
const ZSProvider = (() => {
  ...
  // VibeBridge bar stuck on "Agent active" with no way to start a new session.
  ...
  return {
    ...
    unstableWarning:
      "Gemini tends to stop using the VSCode tools after a while in long sessions (model behavior, not the extension). " +
